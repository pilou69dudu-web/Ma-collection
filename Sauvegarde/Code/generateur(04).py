...
collection = []
liste_genres_uniques = set() # Pour stocker les genres uniques de l'Excel
...
for index, row in df.iterrows():
    ...
    if genre_vinyl == 'nan' or genre_vinyl == '': 
        ...
        # On ajoute le genre à notre liste pour la liste déroulante (en majuscules pour harmoniser)
...
# Tri alphabétique des genres trouvés pour la liste déroulante
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: sans-serif; }
        ...
        /* Style spécial pour la liste déroulante des genres */
        .genre-select { background: white; border: 1px solid var(--border-color); padding: 6px 12px; font-size: 14px; font-weight: 600; border-radius: 4px; outline: none; cursor: pointer; color: var(--discogs-black); }
        .genre-select.active { background: var(--discogs-yellow); border-color: var(--discogs-yellow); }
...
html_fin = """
        ...
        // Remplissage automatique de la liste déroulante des genres
        const selectMenu = document.getElementById('genreSelect');
        ...
        // Écouteur de changement sur la liste déroulante des genres
...
print("\n🎉 Terminé ! Les genres sont désormais regroupés dans un menu déroulant automatique et triés de A à Z.")