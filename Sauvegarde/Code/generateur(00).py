...
def telecharger_pochette(release_id, artiste, titre):
    ...
    try:
        ...
        if reponse.status_code == 200:
            ...
            # Si l'API répond mais qu'il n'y a pas d'image dans la fiche Discogs
...
# =====================================================================
# CRÉATION DU HTML SÉCURISÉ (PLUS DE TRIPLE GUILLEMETS PYTHONIQUES)
# =====================================================================
...
print("\n🎉 Tout est en ordre ! Les alertes de pochettes manquantes s'afficheront à nouveau lors du scan.")