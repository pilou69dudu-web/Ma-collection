...
if not colonne_genre and len(df.columns) > 6:
    colonne_genre = df.columns[6] # Force la colonne G (index 6) si le nom n'est pas détecté
...
html_fin = """
        let currentSearch = "", currentType = "ALL", currentAlpha = "ALL";
...
print("\n🎉 Terminé ! Les genres s'affichent maintenant sur vos fiches. Vous pouvez aussi chercher par genre dans la barre de recherche !")